<?php
  ...
  header('Link: <https://api.keyman.com/schemas/keymanweb-cloud-api/keymanweb-cloud-api.1.0.json#>; rel="describedby"');
  ...
  function getKeyboardURI($name, $version) {
    ...
    return "https://s.keyman.com/keyboard/$name/$version/$name-$version.js";
  }
