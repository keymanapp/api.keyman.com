...
DROP PROCEDURE IF EXISTS sp_keyboard_search_langtags;

DELIMITER #

CREATE PROCEDURE sp_keyboard_search_langtags (
 IN prmSearchRegex NVARCHAR(250),
 IN prmSearchPlain NVARCHAR(250),
 IN prmMatchType INT
)
READS SQL DATA
BEGIN

  DROP TEMPORARY TABLE IF EXISTS tt_languages;

  CREATE TEMPORARY TABLE tt_languages (
...
DROP PROCEDURE IF EXISTS sp_language_search_langtags;

CREATE PROCEDURE sp_language_search_langtags (
 IN prmSearchRegEx NVARCHAR(250),
 IN prmSearchPlain NVARCHAR(250),
 IN prmMatchType INT,
 IN prmAll BIT
...
DROP PROCEDURE IF EXISTS sp_country_search_langtags;

CREATE PROCEDURE sp_country_search_langtags (
 IN prmSearchRegEx NVARCHAR(250),
 IN prmSearchPlain NVARCHAR(250),
 IN prmMatchType INT
)
